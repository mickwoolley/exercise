...
/**
 * An activity representing a single OrderItem detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link OrderItemListActivity}.
 * <p>
...
public class OrderItemDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(OrderItemDetailFragment.ARG_ITEM_ID,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, OrderItemListActivity.class));
            return true;
        }
