 ...
 * {@link OrderItemListFragment} and the item details
 * (if present) is a {@link OrderItemDetailFragment}.
 * <p>
...
public class OrderItemListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.orderitem_detail_container) != null) {
            ...
            ((OrderItemListFragment) getFragmentManager()
                    .findFragmentById(R.id.orderitem_list))
    ...
    /**
     * Callback method from {@link OrderItemListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            Intent detailIntent = new Intent(this, OrderItemDetailActivity.class);
            detailIntent.putExtra(OrderItemDetailFragment.ARG_ITEM_ID, id);
